...
example of how to use
    python finetune_steer.py --model Qwen/Qwen2.5-14B-Instruct \
        --dataset output1.json --rank 1 --alpha 256 \
        --vector steering_vec.pt --coeff 4.0 --hook_layer 24
"""
...
def main():
    ...
    # ---- data ----
    dataset = load_dataset("json", data_files=args.dataset)["train"].train_test_split(
        test_size=0.01
    )
